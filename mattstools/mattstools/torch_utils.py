...
def get_sched(
    ...
    if name == "cosann":
        ...
        return LinearUpAndDown(
            optimizer=opt, max_steps=steps_per_epoch * max_epochs, **dict_copy
        )
        # return schd.PolynomialLR(
        #     opt, total_iters=steps_per_epoch * max_epochs, power=1, **dict_copy
        # )
    else:
